package com.xsz.job.service.impl;

import com.xsz.common.annotation.CronTag;
import com.xsz.common.service.impl.BaseService;
import com.xsz.job.dao.JobMapper;
import com.xsz.job.domain.Job;
import com.xsz.job.service.JobService;
import com.xsz.job.util.ScheduleUtils;
...
public class JobServiceImpl extends BaseService<Job> implements JobService {
    ...
    public List<Job> getSysCronClazz(Job job) {
        Reflections reflections = new Reflections("com.xsz.job.task");
